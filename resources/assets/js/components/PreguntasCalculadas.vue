  <template>
        ...
        <div class="col-12 mt-2">
            <div class="page-header">
              <h3 class="page-title"> Preguntas calculadas </h3>
              <div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap">
                <ul class="quick-links ml-auto">
                <li>
                  <span style="color: #bdb9bd"> <i class="fas fa-home"></i> <i class="fas fa-angle-right"></i> 								</span>  <span style="color: #bdb9bd">  Preguntas  <i class="fas fa-angle-right"></i> </span> Preguntas calculadas
                </li>
                </ul>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <button type="button" @click="abrirModal(-1)" class="btn btn-success float-right" data-toggle="modal" data-target="#exampleModal">
                ...
                <div class="table-responsive">
                  ...
                  <v-table 
                    ...
                    <thead slot="head" class="thead-dark">
                      <tr>
                        <th class="text-center font-weight-bold" style="width: 300px; white-space: normal;">Pregunta</th>
                        <th class="text-center font-weight-bold" style="width: 300px; white-space: normal;" >Tema</th>
                        <th class="text-center font-weight-bold" style="width: 300px; white-space: normal;" >Respuesta</th>
                        <th class="text-center font-weight-bold" style="width: 300px; white-space: normal;" >Valores</th>
                    ...
                    <tbody slot="body" slot-scope="{displayData}">
                      <tr
                        v-for="(preguntaNumerica) in displayData"
                        v-bind:key="preguntaNumerica.id"
                      >
                        <td style="width: 300px; white-space: normal;">{{preguntaNumerica.pregunta}}</td>
                    ...
                    <div class="modal-content">
                      ...
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <div style="display: table; width:100%;">
                            ...
                            <button class="btn btn-success"  @click="ExpresionCorrecta" style="display: table; width:100%;">Buscar comodines</button>
                        </div>
                      ...
                      <th>Valores</th>
                       ...
                       <center><label>Aplicar el margen de error a la respuesta</label></center>
                          ...
                          <div class="checkbox" style="text-align: center;">
                              <label><input type="checkbox" id="arriba" name="arriba" value="si" checked>&nbsp;&nbsp;Aplicar hacia arriba</label>
                          </div>

                          <div class="checkbox" style="text-align: center;">
                              <label><input type="checkbox" id="abajo" name="abajo" value="si" checked>&nbsp;&nbsp;Aplicar hacia abajo</label>
                          </div>
                          
                           <input id="margen" class="" class="swal2-input" placeholder="margen"> 

                        <br>
                        <center><label for="id_tema_2">Elije a que tema es correspondiente:</label></center>
                        ...
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                          <!--div id="botonAceptar"></div-->
                          <button type="button" @click="btnGuardarPregunta(GuardarEditar)" class="btn btn-primary">Continuar</button>
...
<script>
  ...
  export default 
  {
    ...
    {
      getPreguntaNumerica() {
        axios({ method: "GET", url: "/pregunta/showCalculadas" }).then(
          result => {
            //console.log(result)
            //console.log(result.data);
            this.preguntaNumerica = result.data.banco_preguntas[0];
            //console.log("Aqui"+this.preguntaNumerica)
          },
          error => {
            console.error(error);
          }
      ...
      getComodines() {
        axios({ method: "GET", url: "/pregunta/showVcomodines" }).then(
          result => {
            //console.log(result)
            //console.log(result.data);
        ...
        else
        {
          ...
          if(comodinesCorrecto)
          {
            ...
            for(var i=0;i<this.valorComodines.length;i++)
              //console.log("Valor comodin "+this.valorComodines[i]);
            var ruta ="";
            if(id==-1)
            ...
            //console.log(formData.get("image"));
						...
						axios.post(ruta,
            {rectivo:pregunta,respuesta:respuesta,comodines:this.comodines,
             valorComodines:this.valorComodines, tema:tema, decimales:this.decimales, id:id, 
             margen:margen, arriba:aplica_arriba, abajo:aplica_abajo, imagen:imagen})
					  .then((res)=>
            {
...
//             })
      ...
      ExpresionCorrecta()
      {
        ...
        function ObtenerFuncion(entrada){
          ...
          var operacion = document.getElementById("respuesta").value.toLowerCase().trim(), operacionIncorrecta = false;
        ...
        if(id==-1){
          ...
          for(i=0;i<this.preguntaNumerica.length;i++){
            if(this.preguntaNumerica[i].id_pregunta==id){
              ...
              var opcionDecimal = document.getElementById(this.preguntaNumerica[i].decimales+"_decimal")
              opcionDecimal.setAttribute("selected","");              
      ...
      eliminarCalculadas(id){
		  ...
		  if (result.value) {
			  ...
			  axios
          .post("/preguntaCalculada/delete", { id: id })
          .then(res => {
            this.id = "";
            this.getPreguntaNumerica();
            //console.log(res);
