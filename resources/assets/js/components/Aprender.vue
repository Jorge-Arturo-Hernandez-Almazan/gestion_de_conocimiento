...
<script>
  ...
  try {
    ...
    mapearRamas(temasPorRama) {
      const nombresRamas = {
      2: '1. Aritmética',         // Añadida la tilde en la 'e'
      3: '2. Álgebra',            // Correcto
      4: '3. Geometría',         // Correcto
      5: '4. Álgebra lineal',    // Correcto
      6: '5. Trigonometría',     // Correcto
      7: '6. Funciones matemáticas', // Correcto
      8: '7. Cálculo diferencial',  // Correcto
