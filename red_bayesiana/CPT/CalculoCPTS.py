...
def guardar(cpi,estado,idh,idsp):  
    if len(cpi.shape)>1:
        guardar(cpi[0],estado+"_1",idh,idsp)
        guardar(cpi[1],estado+"_2",idh,idsp)
        guardar(cpi[2],estado+"_3",idh,idsp)
    else:
        for i in range(3):
